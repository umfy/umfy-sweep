...
[_ARROWS] = LAYOUT_split_3x5_2(
    KC_ESC, KC_BSPC, KC_DEL, KC_CAPS, _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_BSPC,
    KC_TAB, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,
    KC_ENT, _______, _______, _______, _______, _______, CTLLEFT, KC_DOWN, CTLRGHT, KC_ESC,
...
[_SYMBOL] = LAYOUT_split_3x5_2(
     KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_DEL,  
...
[_SYSTEM] = LAYOUT_split_3x5_2(
    ...
    KC_PSCR, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, KC_CALC, KC_MYCM, COLEMAK, QWERTY, KC_F11,
...
[_FMWARE] = LAYOUT_split_3x5_2(
     ...
     DEBUG,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
